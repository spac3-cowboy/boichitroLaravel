                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="{{route('productSingleView',$product->slug)}}">
                                            <?php
                                            $productImage = \App\Models\ProductImage::where('product_id', $product->id)->where('position_key', 1)->first();
                                            ?>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-name">
                                            <a href="{{route('productSingleView',$product->slug)}}">{{$product->title}}</a>
                                        </h3>
                                        ...
                                        <div class="product-pa-wrapper">
                                            <div class="product-price">
                                                {{$product->current_selling_price/100}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
