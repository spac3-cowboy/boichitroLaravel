...
<head>
    ...
    <link href="{{asset('backend/assets/css/nice-select.css')}}" rel="stylesheet" type="text/css">
...
<!-- Dashboard App js -->
<script src="{{asset('bacekend/assets/js/dashboard/demo.dashboard.js')}}"></script>

<!-- App js -->
<script src="{{asset('backend/assets/js/app.min.js')}}"></script>
<script src="{{asset('backend/assets/js/nice-select.min.js')}}"></script>
