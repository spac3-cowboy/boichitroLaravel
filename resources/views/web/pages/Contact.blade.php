                ...
                <div class=" swiper-container swiper-theme " data-swiper-options="{
                    ...
                    <div class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1">
                        ...
                        <div class="swiper-slide icon-box text-center icon-box-primary">
                            ...
                            <div class="icon-box-content">
                                <h4 class="icon-box-title">Letter</h4>
                                <p>Rangamati, Banorupa</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="accordion accordion-bg accordion-gutter-md accordion-border">
                            <div class="card">
                                ...
                                <div id="collapse1" class="card-body expanded">
                                    <p class="mb-0">
                                        You have to contact us through our phone number.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapse2" class="card-body collapsed">
                                    <p class="mb-0">
                                        Registration will be done soon as soon as we are back in our office.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapse4" class="card-body collapsed">
                                    <p class="mb-0">
                                        Please look at our policy to find at out.
                                    </p>
                                </div>
                            </div>
