        ...
        <div class="page-title-box">
            ...
            <form action="" method="">
                <div class="input-group mb-3">
                    <input type="search" class="form-control" name="search" value="{{$search}}"  placeholder="Search with Product title" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                        <button class="btn btn-outline-success" type="submit">Search</button>
                        <a href="{{url('/in-admin/product/index')}}">
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('InAdmin.Product.Discount.Page', $product->id)}}"  class="btn btn-info btn-sm">Add Discount</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
