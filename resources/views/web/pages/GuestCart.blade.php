...
@section('content')
    ...
    $cartCount = \App\Models\GuestCart::where('guest_user_id', $guestUserId )->exists();
    ?>
    @if($cartCount != NULL)
            ...
            <div class="container">
                <div class="row gutter-lg mb-10">
                    ...
                    <div class="col-lg-8 pr-lg-4 mb-6">
                        <form action="{{route('UpdateGuestCart')}}" method="POST">
                            @csrf
                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        <div class="p-relative">
                                            ...
                                            <a href="{{route('DeleteGuestCart', $cart->id)}}"  class="btn btn-close"><i
